...
var PDFReportGenerator = /** @class */ (function () {
     ...
     */
    PDFReportGenerator.prototype.generateReport = function (reportData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                pdfBuffer = Buffer.from(this.doc.output('arraybuffer'));
     ...
     * Add cover page
     */
    PDFReportGenerator.prototype.addCoverPage = function (reportData) {
        ...
        this.addText("Prepared for: ".concat(reportData.companyName), this.margin, 140); // 36pt spacing after title
        // Contact details with improved line spacing
        this.doc.setFontSize(11);
        this.doc.setFont('helvetica', 'normal');
        this.doc.setTextColor(64, 64, 64); // #404040 - medium gray for body text
        var currentY = 154; // Start position for contact info
        var lineHeight = 14; // 1.4x line height for 11pt font
        this.addText("Contact: ".concat(reportData.contactName), this.margin, currentY);
        currentY += lineHeight;
        this.addText("Email: ".concat(reportData.contactEmail), this.margin, currentY);
        if (reportData.website) {
            currentY += lineHeight;
            this.addText("Website: ".concat(reportData.website), this.margin, currentY);
        }
        currentY += lineHeight;
        this.addText("Department Focus: ".concat(reportData.departmentFocus), this.margin, currentY);
        currentY += lineHeight;
        this.addText("Analysis Date: ".concat(reportData.analysisDate), this.margin, currentY);
        ...
        var footerY = this.pageHeight - 40; // 40pt from bottom
     ...
     */
    PDFReportGenerator.prototype.addBusinessReportContent = function (reportContent) {
     ...
     */
    PDFReportGenerator.prototype.addHeading = function (text, level) {
        ...
        var spaceRemaining = this.pageHeight - this.currentY - this.bottomMargin;
     ...
     */
    PDFReportGenerator.prototype.addBoldText = function (text) {
        // Check if we have enough space for bold text + 3 lines (approx 18mm)
        var requiredSpace = 18;
        var spaceRemaining = this.pageHeight - this.currentY - this.bottomMargin;
        if (spaceRemaining < requiredSpace) {
            // Not enough space, move to next page
            this.addNewPage();
     ...
     */
    PDFReportGenerator.prototype.addParagraph = function (text) {
        var maxWidth = this.pageWidth - (this.margin * 2);
        var words = text.split(' ');
        var currentLine = '';
        var lineHeight = 7; // Improved line height for better readability
        for (var _i = 0, words_1 = words; _i < words_1.length; _i++) {
            var word = words_1[_i];
            var testLine = currentLine ? "".concat(currentLine, " ").concat(word) : word;
            var textWidth = this.doc.getTextWidth(testLine);
     ...
     * Helper methods
     */
    PDFReportGenerator.prototype.addNewPage = function () {
        this.doc.addPage();
        this.pageNumber++;
    ...
    PDFReportGenerator.prototype.addSectionHeader = function (title) {
        // Check if we have enough space for section header + content (approx 48mm)
        var requiredSpace = 48;
        var spaceRemaining = this.pageHeight - this.currentY - this.bottomMargin;
        if (spaceRemaining < requiredSpace) {
            // Not enough space, move to next page
            this.addNewPage();
    ...
    PDFReportGenerator.prototype.addText = function (text, x, y, letterSpacing) {
    ...
    PDFReportGenerator.prototype.addFootersToAllPages = function () {
        var totalPages = this.doc.getNumberOfPages();
        for (var i = 1; i <= totalPages; i++) {
            ...
            if (i > 1 && this.logoBase64) {
                try {
                    ...
                    var logoWidth = 20;
                    var logoHeight = 20; // Square logo based on the PNG
                    var logoX = this.pageWidth - this.margin - logoWidth;
                    var logoY = 10;
            ...
            this.doc.setFont('helvetica', 'normal');
            this.doc.setTextColor(150, 150, 150);
            this.doc.text("Page ".concat(i, " of ").concat(totalPages), this.pageWidth - this.margin - 20, this.pageHeight - 10);
            // VeloxForce footer
            this.doc.text('VeloxForce - Service-as-Software Solutions', this.margin, this.pageHeight - 10);
        }
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, generator.generateReport(reportData)];
